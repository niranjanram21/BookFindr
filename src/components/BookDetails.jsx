                ...
                <div className="md:w-2/3 md:pl-8 lg:px-8 bg-white bg-opacity-60 mx-auto p-2 lg:py-12">
                    ...
                    <div className="flex gap-2 mt-2">
                        <button 
                            ...
                            className={`inline-flex items-center bg-transparent border border-red-600 ${isInCart ? 'bg-red-600 text-white' : 'bg-red-100'} py-2 px-6 font-bold focus:outline-none hover:${isInCart ? 'bg-red-400' : 'bg-red-600 hover:text-white'} hover:scale-110 transition duration-200 ease-in-out rounded-none text-base mt-2 md:mt-0`}
                        >
